...
The confidence-scoring rubric lives in `scoring-prompt.md` — it is dispatched as a separate scoring agent in `/pr-review` Phase 4, not by these specialist agents.

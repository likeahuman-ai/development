...
In async code, also flag error-handling quality — unhandled rejections, `.catch(() => {})`, and missing error callbacks — since these are silent failures regardless of where the state ends up.
